...
public class ReversibleRangeSlider extends BaseSlider<ReversibleRangeSlider, ReversibleRangeSlider.OnChangeListener, ReversibleRangeSlider.OnSliderTouchListener> {

  public ReversibleRangeSlider(@NonNull Context context) {
    this(context, null);
  }

  public ReversibleRangeSlider(@NonNull Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, R.attr.sliderStyle);
  }

  public ReversibleRangeSlider(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
   ...
   */
  public interface OnChangeListener extends BaseOnChangeListener<ReversibleRangeSlider> {}

  /** Interface definition for a callback invoked when a slider's value is changed. */
  public interface OnSliderTouchListener extends BaseOnSliderTouchListener<ReversibleRangeSlider> {}
